...
public class Device {
	...
	public boolean isSaved = false; // 저장 유무
	public boolean isStart = false; // 동작 유무
	public boolean isConnect = false; // 연결 유무
	...
	// 이미 1대의 subscriber pc가 지정되어 작동하는지를 판별하는 변수
	public static boolean existSub = false;

	// 현재 작동되는 client index를 저장한 list
